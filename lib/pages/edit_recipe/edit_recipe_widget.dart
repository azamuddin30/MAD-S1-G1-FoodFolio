...
class EditRecipeWidget extends StatefulWidget {
  const EditRecipeWidget({
    Key? key,
    required this.recipeRef2,
  }) : super(key: key);

  final DocumentReference? recipeRef2;
...
class _EditRecipeWidgetState extends State<EditRecipeWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<RecipeRecord>(
      stream: RecipeRecord.getDocument(widget.recipeRef2!),
      builder: (context, snapshot) {
        ...
        final editRecipeRecipeRecord = snapshot.data!;
        return Scaffold(
          key: scaffoldKey,
          backgroundColor: Colors.white,
          appBar: AppBar(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: TextFormField(
                            ...
                            validator: _model
                                .descriptionRecipeControllerValidator
                                .asValidator(context),
                          ),
                        ),
                        Padding(
                              ...
                              onPressed: () async {
                                ...
                                await showDialog(
                                  ...
                                  builder: (alertDialogContext) {
                                    return AlertDialog(
                                      title: Text('Note'),
                                      content: Text('Recipe has been saved'),
                                      actions: [
                                        TextButton(
                                          onPressed: () =>
