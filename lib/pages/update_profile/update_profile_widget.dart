...
class _UpdateProfileWidgetState extends State<UpdateProfileWidget> {
  ...
  void initState() {
    ...
    _model.emailtextField2Controller ??=
        TextEditingController(text: currentUserEmail);
    _model.phoneNrTextFieldController ??=
                        ...
                        children: [
                          ...
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                20.0, 0.0, 20.0, 16.0),
                            child: TextFormField(
                              controller: _model.emailtextField2Controller,
                              textCapitalization: TextCapitalization.words,
                              obscureText: false,
                              decoration: InputDecoration(
                          ...
                          Padding(
                            ...
                            child: AuthUserStreamWidget(
                              builder: (context) => TextFormField(
                                controller: _model.phoneNrTextFieldController,
                                textCapitalization: TextCapitalization.words,
                                obscureText: false,
                                decoration: InputDecoration(
                                  ...
                                  return FFButtonWidget(
                                    onPressed: () async {
                                      await currentUserReference!
                                        ...
                                        email: _model
                                            .emailtextField2Controller.text,
                                        displayName:
                                            _model.yourNameController.text,
                                        phoneNumber: _model
                                            .phoneNrTextFieldController.text,
                                      ));
