...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => RecipeDetailsWidget(
            recipeRef: params.getParam(
                'recipeRef', ParamType.DocumentReference, false, ['Recipe']),
          ),
        ),
        FFRoute(
          name: 'ResetPassword',
        ...
        FFRoute(
          ...
          path: '/addRecipe2',
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'AddRecipe2')
              : AddRecipe2Widget(),
        ),
        FFRoute(
          name: 'updateProfile',
        ...
        FFRoute(
          ...
          builder: (context, params) => EditRecipeWidget(
            recipeRef2: params.getParam(
                'recipeRef2', ParamType.DocumentReference, false, ['Recipe']),
          ),
        )
